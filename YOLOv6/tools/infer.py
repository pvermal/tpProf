...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--yaml', type=str, default='YOLOv6/data/coco.yaml', help='data yaml file.')
    ...
    parser.add_argument('--project', default='runs/detect', help='save inference results to project/name.')
